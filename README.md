...
- RFCs that are candidates for inclusion in React will enter a "final comment period" 7 calendar days. The beginning of this period will be signaled with a comment and tag on the RFC's pull request.
